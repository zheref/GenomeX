...
export default function IdentifyYourself(): React.ComponentElement<any, any> {
  return (
      <SafeAreaView style={styles.safeArea}>
        <KeyboardAwareScrollView keyboardDismissMode="interactive" contentInset={{top: 160, left: 0, bottom: 0, right: 0}} scrollEnabled={false} resetScrollToCoords={{x: 0, y: 0,}}>
          <Column style={styles.column}>
            <>
              <Text style={styles.welcomeText}>Welcome</Text>
              <Text style={styles.prompt}>Let us know who you are...</Text>
              <RegularInput style={styles.input} placeholder="Enter your bio handle" />
